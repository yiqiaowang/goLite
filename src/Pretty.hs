...
instance Pretty Parameter where
  pretty (Parameter idList t) i = concat 
    [commaSepList idList i, " ", pretty t 0]

instance Pretty Clause where
  pretty (Case exList stList) i = concat 
    [spacePrint i, "case ", commaSepList exList i, ":\n", 
...
instance Pretty All where
  ...
  pretty (Function name params (Just t) stmts) _ = 
    concat ["func ", pretty name 0, "(",
    commaSepList params 0, ") ", pretty t 0,
    " {\n", prettyList stmts 1, "}\n"]
...
instance Pretty Stmt where
  pretty (VarDec (Variable var (Just t) [])) i = concat
    [spacePrint i, "var ", commaSepList var i, " ", pretty t i, ";\n"]
  pretty (VarDec (Variable var (Just t) expr)) i = concat
    [spacePrint i, "var ", commaSepList var i, 
    " ", pretty t i, " = ", commaSepList expr i, ";\n"]
  pretty (VarDec (Variable var Nothing expr)) i = concat
    [spacePrint i, "var ", commaSepList var i, " = ",
    commaSepList expr i, ";\n"]
  ...
  pretty (Print expr) i = concat [spacePrint i, "print(",
    commaSepList expr i, ");\n"]
  pretty (Println expr) i = concat [spacePrint i, "println(",
    commaSepList expr i, ");\n"]
  pretty (Return Nothing) i = concat [spacePrint i, "return;\n"]
  pretty (Return (Just expr)) i = concat [spacePrint i,
...
instance Pretty Expression where
  ...
  pretty (Equals expr1 expr2) i = concat [pretty expr1 i, " == ", pretty expr2 i]
  pretty (NotEquals expr1 expr2) i = concat [pretty expr1 i, " != ", pretty expr2 i]
  pretty (LThan expr1 expr2) i = concat [pretty expr1 i, " < ", pretty expr2 i]
  pretty (LEThan expr1 expr2) i = concat [pretty expr1 i, " <= ", pretty expr2 i]
  pretty (GThan expr1 expr2) i = concat [pretty expr1 i, " > ", pretty expr2 i]
  pretty (GEThan expr1 expr2) i = concat [pretty expr1 i, " >= ", pretty expr2 i]
